module.exports = {
  ...
  entry: [
    '/Users/dongyian/Workspaces/react-app-boilerplate/node_modules/react-dev-utils/webpackHotDevClient.js',
    '/Users/dongyian/Workspaces/react-app-boilerplate/src/index.js'
  ],
  output: {
    pathinfo: true,
        ...
        oneOf: [
          ...
          },
          {
            ...
            options: {
              ...
              cacheIdentifier:
                'development:babel-plugin-named-asset-import@0.3.3:babel-preset-react-app@9.0.1:react-dev-utils@9.0.3:react-scripts@3.1.1',
              plugins: [
                [
          ...
          },
          {
            ...
            exclude: {},
            use: [
              '/Users/dongyian/Workspaces/react-app-boilerplate/node_modules/style-loader/dist/index.js',
              {
                loader:
  ...
  plugins: [
    ...
    { replacements: { NODE_ENV: 'development', PUBLIC_URL: '' } },
